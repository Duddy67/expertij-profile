<?php namespace Codalia\Profile\Helpers;
...
class ProfileHelper
{
    ...
    /**
     * Checks out a given item for a given backend user.
     *
	...
	$html .= '<div class="check-in"><p class="user-check-in">'.$userName.'</p>'.Backend::dateTime($record->profile->checked_out_time).'</div>';
